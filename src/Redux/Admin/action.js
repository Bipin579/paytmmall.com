...
export const addUser=(user)=>async(dispatch) => {
    try {
        const {data } =await axios.post("https://paytmmallserver.onrender.com/users", user);
        console.log(data);
        // dispatch()
    } catch (error) {
        // dispatch()
...
export const deleteUser = (email) => async (dispatch) => {
    ...
    try {
        const { data } = await axios.delete(`https://paytmmallserver.onrender.com/users?email=${email}`);
